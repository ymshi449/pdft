...
os.environ["VECLIB_MAXIMUM_THREADS"] = "17" # export VECLIB_MAXIMUM_THREADS=4
os.environ["NUMEXPR_NUM_THREADS"] = "18" # export NUMEXPR_NUM_THREADS=6
